...
esbuild src/react-app/index.tsx --loader:.svg=dataurl --bundle --outfile=lib/src/react-app/bundle.js --platform=browser --format=iife --minify --tree-shaking=true --target=es2020
